...
iceberg_light_blue="#98c379"
onedark_visual_grey="#3e4452"
onedark_comment_grey="#5c6370"

# My colours
iceberg_light_blue="#03b6fc"
iceberg_deep_blue="#1303fc"
iceberg_purple="#ad03fc"
...
set "pane-active-border-fg" "$iceberg_light_blue"
set "pane-active-border-bg" "$onedark_black"

set "display-panes-active-colour" "$iceberg_light_blue"
...
set "@prefix_highlight_bg" "$iceberg_light_blue"
set "@prefix_highlight_copy_mode_attr" "fg=$onedark_black,bg=$iceberg_light_blue"
set "@prefix_highlight_output_prefix" "  "

status_widgets=$(get "@onedark_widgets")
time_format=$(get "@onedark_time_format" "%H:%M:%S")
date_format=$(get "@onedark_date_format" "%d/%m/%Y")

set "status-right" "#[fg=$onedark_white,bg=$onedark_black,nounderscore,noitalics]${time_format}  ${date_format} #[fg=$onedark_visual_grey,bg=$onedark_black]#[fg=$onedark_visual_grey,bg=$onedark_visual_grey]#[fg=$onedark_white, bg=$onedark_visual_grey]${status_widgets} #[fg=$iceberg_light_blue,bg=$onedark_visual_grey,nobold,nounderscore,noitalics]#[fg=$onedark_black,bg=$iceberg_light_blue,bold] #h #[fg=$onedark_yellow, bg=$iceberg_light_blue]#[fg=$onedark_red,bg=$onedark_yellow]"

set "status-left" "#[fg=$onedark_black,bg=$iceberg_light_blue,bold] #{s|$HOME|~|;s|/.*/|/.../|:pane_current_path} #{prefix_highlight}#[fg=$iceberg_light_blue,bg=$onedark_black,nobold,nounderscore,noitalics]"
